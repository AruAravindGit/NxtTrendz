...
class App extends Component {
  ...
  removeCartItem = id => {
    this.setState(prev => {
      const itemCheck = prev.cartList.find(eachId => eachId.id === id)
      if (itemCheck !== undefined) {
        const filterList = prev.cartList.filter(eachProd => eachProd.id !== id)
  ...
  decrementCartItemQuantity = id => {
    this.setState(prev => {
      ...
      const updatedList = upList.filter(eachId => eachId.id !== undefined)
